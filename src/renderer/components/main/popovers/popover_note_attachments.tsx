...
const PopoverNoteAttachments = ({ addAttachments, attachments, isEditing, toggleEditing }: { addAttachments: () => void; attachments: string[]; isEditing: boolean; toggleEditing: (...args: any[]) => void }) => (
